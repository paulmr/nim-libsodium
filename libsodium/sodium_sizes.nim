...
proc crypto_pwhash_bytes_max*(): csize {.sodium_import.}
proc crypto_pwhash_bytes_min*(): csize {.sodium_import.}
proc crypto_pwhash_memlimit_interactive*(): csize {.sodium_import.}
proc crypto_pwhash_memlimit_max*(): csize {.sodium_import.}
proc crypto_pwhash_memlimit_min*(): csize {.sodium_import.}
proc crypto_pwhash_memlimit_moderate*(): csize {.sodium_import.}
proc crypto_pwhash_memlimit_sensitive*(): csize {.sodium_import.}
proc crypto_pwhash_opslimit_interactive*(): csize {.sodium_import.}
proc crypto_pwhash_opslimit_max*(): csize {.sodium_import.}
proc crypto_pwhash_opslimit_min*(): csize {.sodium_import.}
proc crypto_pwhash_opslimit_moderate*(): csize {.sodium_import.}
proc crypto_pwhash_opslimit_sensitive*(): csize {.sodium_import.}
proc crypto_pwhash_passwd_max*(): csize {.sodium_import.}
proc crypto_pwhash_passwd_min*(): csize {.sodium_import.}
proc crypto_pwhash_saltbytes*(): csize {.sodium_import.}
proc crypto_pwhash_scryptsalsa208sha256_saltbytes*(): csize {.sodium_import.}
proc crypto_pwhash_scryptsalsa208sha256_strbytes*(): csize {.sodium_import.}
proc crypto_pwhash_strbytes*(): csize {.sodium_import.}
